...
google.devrel.samples.hello.CLIENT_ID =
    '954883670747-97hg3kq6ordt58k9cinkc29tg6jvso37.apps.googleusercontent.com';
...
/**
 * Gets the latest greeting via the API.
 */
/*
google.devrel.samples.hello.getLatestGreeting = function() {
  gapi.client.helloworld.greetings.getLatestGreeting().execute(
      function(resp) {
        if (!resp.code) {
          google.devrel.samples.hello.print(resp);
        } else {
 ...
 */
google.devrel.samples.hello.postGreeting = function(
		irkit_id, signal_name, signal_content, post_id) {
...
google.devrel.samples.hello.enableButtons = function() {
  ...
  document.getElementById('postGreetings').onclick = function() {
    google.devrel.samples.hello.postGreeting(
        document.getElementById('irkit_id').value,
        document.getElementById('signal_name').value,
        document.getElementById('signal_content').value,
